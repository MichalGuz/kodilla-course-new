...
public class BookDirectoryTestSuite {
    ...
    public void testlistBooksInHands() {
        ...
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser user0 = new LibraryUser("user", "user0", "0001");
        LibraryUser user1 = new LibraryUser("user", "user1", "0001");
        LibraryUser user5 = new LibraryUser("user", "user5", "0001");
        ...
        when(libraryDatabaseMock.listBooksInHandsOf(user0)).thenReturn(resultListOfZeroBooks);
        when(libraryDatabaseMock.listBooksInHandsOf(user1)).thenReturn(resultListOfOneBook);
        when(libraryDatabaseMock.listBooksInHandsOf(user5)).thenReturn(resultListOfFiveBooks);
